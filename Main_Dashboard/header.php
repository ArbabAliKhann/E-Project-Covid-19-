                   ...
                   <div class="row row-cols-3 gx-2">
                      <div class="col">
                        <a href="ecommerce-orders.html">
                         <div class="apps p-2 radius-10 text-center">
                            ...
                            <p class="mb-0 apps-name">Hospitals</p>
                         </div>
                        </a>
                      </div>
                      <div class="col">
                        ...
                        <div class="apps p-2 radius-10 text-center">
                           ...
                           <p class="mb-0 apps-name">Pateints</p>
                        </div>
                      </a>
                     </div>
                     <div class="col">
                      ...
                      <div class="apps p-2 radius-10 text-center">
                         ...
                         <p class="mb-0 apps-name">Vaccines</p>
                      </div>
                      </a>
                    </div>
                    <div class="col">
                      <a href="../MainLayout/logout.php">
                      <div class="apps p-2 radius-10 text-center">
                    ...
                    <div class="col">
                      ...
                      <div class="apps p-2 radius-10 text-center">
                         ...
                         <p class="mb-0 apps-name">Booking</p>
                      </div>
                    </a>
                    </div>
                    <div class="col">
                      ...
                      <div class="apps p-2 radius-10 text-center">
                         ...
                         <p class="mb-0 apps-name">Reports</p>
                      </div>
                      </a>
                    </div>
                   </div><!--end row-->
        ...
        <aside class="sidebar-wrapper" data-simplebar="true">
          ...
          <ul class="metismenu" id="menu">
            ...
            <li>
              ...
              <ul>
                <li> <a href="app-emailbox.html"><i class="bi bi-arrow-right-short"></i>Patients List</a>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul>
                <li> <a href="widgets-static-widgets.html"><i class="bi bi-arrow-right-short"></i>Covid Reports</a>
                </li>
              </ul>
            </li>
            <li>
              <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Vaccines</div>
              </a>
              <ul>
                <li> <a href="ecommerce-products-list.html"><i class="bi bi-arrow-right-short"></i>Add Vacine</a>
                </li>
                <li> <a href="ecommerce-products-grid.html"><i class="bi bi-arrow-right-short"></i>View Vaccine List</a>
                </li>
              </ul>
            </li>
            <li>
              <a class="has-arrow" href="javascript:;">
                ...
                <div class="menu-title">Hospital Log</div>
              </a>
              <ul>
                <li> <a href="component-alerts.html"><i class="bi bi-arrow-right-short"></i>Hospitals Requests</a>
                </li>
                <li> <a href="component-accordions.html"><i class="bi bi-arrow-right-short"></i>View Hospital List</a>
                </li>
              </ul>
            </li>
            <li>
              <a class="has-arrow" href="javascript:;">
                ...
                <div class="menu-title">Booking Details</div>
              </a>
              <ul>
                <li> <a href="icons-line-icons.html"><i class="bi bi-arrow-right-short"></i>Patient Booking Details</a>
                </li>
              </ul>
            </li>
            <li>
