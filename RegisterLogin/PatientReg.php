...
<body>
    ...
    <div class="container-fluid full-bg h-100">
        <div class="container h-100">
            <form action="PatientReg.php" method="post" enctype="multipart/form-data" class="mt-5">
                    ...
                    <div class="bg-layer d-flex col-md-4">
                        <div class="login-box row">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Full Name" aria-label="Username" aria-describedby="basic-addon1" name="name" required>
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Contact Number" aria-label="Username" aria-describedby="basic-addon1" name="contact" required>
                            </div>
                            ...
                            <p class="no-c">Already have Account? <a href="PatientLogin.php">Sign In</a></p>
    ...
    <?php if (isset($_POST['btn'])) {
        ...
        $Emailquery = "select * from patientdetail where Email = '$Email'";
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            $Insquery = "insert into patientdetail (Name,Email,Address,Contact,Password) values ('$Name','$Email','$Address','$Contact','$Password')";
