              ...
              <li class="nav-item dropdown dropdown-large">
                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                  <div class="user-setting d-flex align-items-center gap-1">
                    ...
                    <div class="user-name d-none d-sm-block"><?= $_SESSION[
                        'db_Name'
                    ] ?></div>
                  </div>
                </a>
                  ...
                  <li>
                     <a class="dropdown-item" href="#">
                       <div class="d-flex align-items-center">
                          ...
                          <div class="ms-3">
                            <h6 class="mb-0 dropdown-user-name"><?= $_SESSION[
                                'db_Name'
                            ] ?></h6>
                      ...
                      <div class="col">
                        <a href="ecommerce-orders.html">
                         <div class="apps p-2 radius-10 text-center">
                            ...
                            <p class="mb-0 apps-name">Book Appointment</p>
                         </div>
                        </a>
                      </div>
                      <div class="col">
                        ...
                        <div class="apps p-2 radius-10 text-center">
                           ...
                           <p class="mb-0 apps-name">Pateint Reports</p>
                        </div>
                      </a>
                     </div>
                     <div class="col">
        ...
        <aside class="sidebar-wrapper" data-simplebar="true">
          ...
          <ul class="metismenu" id="menu">
            ...
            <li>
              ...
              <ul>
                <li> <a href="app-emailbox.html"><i class="bi bi-arrow-right-short"></i>Edit Profile</a>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul>
                <li> <a href="widgets-static-widgets.html"><i class="bi bi-arrow-right-short"></i>Patient Test</a>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul>
                <li> <a href="appointment.php"><i class="bi bi-arrow-right-short"></i>Book</a>
                </li>
                <li> <a href="viewAppointment.php"><i class="bi bi-arrow-right-short"></i>My Appointment</a>
                </li>
              </ul>
            </li>
            <li>
